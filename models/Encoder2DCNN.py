...
class AutoEncodeCNN(nn.Module):
    def __init__(self):
        ...
        self.transconv1 = nn.ConvTranspose2d(in_channels=32, out_channels=32, kernel_size=(3, 3), stride=2, padding=1)
        self.transconv2 = nn.ConvTranspose2d(in_channels=32, out_channels=1, kernel_size=(3, 3), stride=2, padding=1)
